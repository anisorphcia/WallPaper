package com.asakao.wallpaper.widget

import android.annotation.SuppressLint
import android.widget.ProgressBar
import android.widget.TextView
import com.asakao.wallpaper.R
import com.asakao.wallpaper.common.RxBaseDialog
...
class DownloadDialog : RxBaseDialog() {
    ...
    override fun initView() {
        ...
        downloadUrl = arguments?.getString("downloadUrl").toString()
        ...
        FileDownloader.getImpl().create(downloadUrl)
            ...
            .setListener(object : FileDownloadListener() {
                override fun warn(task: BaseDownloadTask?) {
                    activity?.let { CommonUtil.toast(it, "下载失败") }
                    dismiss()
                }
                ...
                override fun completed(task: BaseDownloadTask?) {
                    ...
                    activity?.let { CommonUtil.toast(it, msg) }
                    dismiss()
                }
